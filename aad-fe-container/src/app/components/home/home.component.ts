  ...
  pillars: BusinessPillar[] = [
    {
      ...
      description:
        'Upload documents, guidelines, and operating playbooks. The system creates a single searchable memory that AI teammates consult before answering questions or taking action.',
      keyPoints: [
    ...
    },
    {
      ...
      description:
        "Your team's active digital workspace. Chat with AI colleagues, review files, draft documents, and let the AI perform safe, multi-turn tasks on your projects.",
      keyPoints: [
    ...
    },
    {
      ...
      description:
        'Try out prompts with different AI roles in a real-time sandbox. Observe how they reason and ensure high-quality, policy-compliant outputs before deploying them to your team.',
      keyPoints: [
