...
flowchart TD
    ...
    subgraph Phase11 ["Phase 11: Production Observability & Startup Telemetry"]
        ...
        Spec28["28-telemetry-pod-endpoint-resolution-spec.md<br/>(Telemetry Pod Endpoint Resolution)"]:::complete
    end

    subgraph Phase12 ["Phase 12: Knowledge Registry UI & BREAD"]
...
| **Phase 14** | [32-knowledge-markdown-import-spec.md](./32-knowledge-markdown-import-spec.md) | `complete` | Knowledge Markdown Import via LLM Extraction | [Knowledge PRD](../prds/knowledge-data-system-prd.md) | Phase 14 Spec (Depends on Spec 29) |
