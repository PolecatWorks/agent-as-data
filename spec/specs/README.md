...
flowchart TD
    ...
    subgraph Phase6 ["Phase 6: Workbench Benches & Project Memory"]
        Spec13["13-workbench-benches-domain-and-scoped-execution-spec.md<br/>(Bench Domain, Schema & Scoped Execution)"]:::draft
...
| **Phase 6** | [13-workbench-benches-domain-and-scoped-execution-spec.md](./13-workbench-benches-domain-and-scoped-execution-spec.md) | `draft` | Benches Domain Models, Database Migrations, Scoped Filesystem APIs (`/tmp/workspace/benches/<id>`), and Rig Tool Scoping | [Workbench Bench & Thread PRD](../prds/workbench-bench-thread-prd.md) | Step 1 of Phase 6 (Depends on Spec 12) |
