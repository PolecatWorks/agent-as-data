...
| **Phase 11** | [28-telemetry-pod-endpoint-resolution-spec.md](./28-telemetry-pod-endpoint-resolution-spec.md) | `draft` | Test Harness Telemetry & Pod Endpoint Resolution Abstraction (Local vs. In-Cluster Pod IPs) | [Master PRD](../prds/agent-as-data-prd.md), [Testing Kit PRD](../prds/agent-ui-testing-kit-prd.md) | Phase 11 Spec (Depends on Spec 27) |
