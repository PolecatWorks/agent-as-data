...
| :--- | :--- |
| [agent-as-data-prd.md](./agent-as-data-prd.md) | **Master PRD**: High-level platform architecture, core objectives, fail-fast startup validation, and HaMS sidecar health/metrics with baseline startup telemetry initialization and Tokio runtime metrics. |
