//! Agent-As-Data MCP Server (`aad-mcp-container`) binary CLI entrypoint.

use std::path::PathBuf;
use clap::{Parser, Subcommand};

use aad_mcp_container::config::AppConfig;
use aad_mcp_container::tokio_tools::run_in_tokio;
use aad_mcp_container::{service_main, VERSION};

#[derive(Parser, Debug)]
#[command(name = "aad-mcp", about = "Agent-As-Data MCP Server Microservice", version)]
pub struct Cli {
...
pub enum Commands {
    /// Start the main MCP application server
    Serve,
